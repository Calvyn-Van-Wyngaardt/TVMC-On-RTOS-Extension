...
public class CZone {
    ...
    public CZone(ArrayList<Clock> c, CZone other)   {
        zeroClock = new Clock(0.0, "clockZero");
        clocks = new ArrayList<>();
        clocks.add(zeroClock);
        for(Clock x: c) {
    ...
    public CZone(ArrayList<Clock> c)   {
        zeroClock = new Clock(0.0, "clockZero");
        clocks = new ArrayList<>();
        clocks.add(zeroClock);
        for(Clock x: c) {
    ...
    public CZone(ArrayList<Clock> c, ArrayList<ClockConstraint> cc)    {
        zeroClock = new Clock();
        clocks = new ArrayList<>();
        clocks.add(zeroClock);
        for(Clock x: c) {
    ...
    public boolean relation(CZone other)    {
...
//        System.out.println("Indexes X: "+x+" Y: "+y+"  "+clocks.get(x).toString());
    ...
    public boolean zoneSubset(CZone other)    {
        return true;
    }
    
    public boolean isEmptyClockZone(CZone other)   {
    ...
    boolean isRedundantZone(CZone other) {
        return true;
        //e.g. x<3 and x < 4
    }
